...
BEGIN_DEFINE_SPEC(FUnLuaLibFRotatorSpec, "UnLua.API.FRotator", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext)
    lua_State* L;
