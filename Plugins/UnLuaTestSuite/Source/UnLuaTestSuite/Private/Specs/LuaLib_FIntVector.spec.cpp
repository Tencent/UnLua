...
BEGIN_DEFINE_SPEC(FUnLuaLibFIntVectorSpec, "UnLua.API.FIntVector", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext)
    lua_State* L;
