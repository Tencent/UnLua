...
BEGIN_DEFINE_SPEC(FUnLuaLibFLinearColorSpec, "UnLua.API.FLinearColor", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext)
    lua_State* L;
