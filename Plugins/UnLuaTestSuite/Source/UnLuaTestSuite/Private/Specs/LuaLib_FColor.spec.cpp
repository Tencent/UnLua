...
BEGIN_DEFINE_SPEC(FUnLuaLibFColorSpec, "UnLua.API.FColor", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext)
    lua_State* L;
