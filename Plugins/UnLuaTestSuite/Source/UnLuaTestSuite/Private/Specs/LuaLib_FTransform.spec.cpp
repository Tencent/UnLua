...
BEGIN_DEFINE_SPEC(FUnLuaLibFTransformSpec, "UnLua.API.FTransform", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext)
    lua_State* L;
