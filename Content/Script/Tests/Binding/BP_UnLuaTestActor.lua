...
function M:RunTest()
    ...
    local ok, err = pcall(function()
        ...
        test("FVectorProperty", UE4.FVector(1,2,3))
        test("FRotatorProperty", UE4.FRotator(2,3,1))

        test("FTransformProperty", UE4.FTransform(UE4.FQuat(0,0,0,1), UE4.FVector(1,2,3)))
        ...
        test("EnumProperty", UE4.ECollisionChannel.Pawn)
    end)
